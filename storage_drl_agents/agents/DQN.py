...
class DQN(Agent):
    ...
    def save(self, filename):
        th.save(self.actor.state_dict(), 'models/'+filename+'_model.pkl')

    def load(self, filename):
        if os.path.isfile('models/'+filename+'_model.pkl'):
            state_dict = th.load('models/'+filename+'_model.pkl', map_location=lambda storage, loc: storage)
